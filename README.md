...
## 1. 소개
<img width="1920" height="1080" alt="10" src="https://github.com/user-attachments/assets/94f11586-9a08-47b2-8c3a-55f8a621cc3a" />
<img width="1920" height="1080" alt="6" src="https://github.com/user-attachments/assets/82b1b27f-8ccf-4dbe-89eb-773e156e83e1" />
...
## 4. 기능구현
- 화염 물리 시뮬레이션 : Ignis - Interactive Fire 에셋사용
...
- 나무가 성장 및 벌목
    지정된 위치에서 생성되는 나무가 시간이 지남에 따라 자라나며 점진적으로 스케일이 커집니다.
    일정 수준의 크기에 도달하면 나무를 클릭하여 벌목할 수 있습니다.
- 어빌리티 시스템
    특정 점수에 도달하거나 상점에서 구매를 통해 게임 플레이에 특별한 효과를 부여하는 어빌리티를 획득할 수 있습니다.
    효과 값은 float로 관리되며 획득 시 부여된 값으로 게임 콘텐츠의 수치적 변화를 계산합니다.
- 인게임 이벤트
